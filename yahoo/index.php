...
<body>
    <div id="nav-yahoo" class="sp-div" style="height: 84px;padding-left: 27px;padding-right: 27px;padding-top: 22px;padding-bottom: 22px;"><img class="img-fluid" width="240" height="72" src="../assets/img/yahoo_frontpage_en-US_s_f_p_bestfit_frontpage_2x.png" style="height: 36px;width: auto;">
        <div><a href="#" style="margin-right: 12px;color: #7d2dfe;font-size: 14px;">Help</a><a href="#" style="margin-right: 12px;color: #7d2dfe;font-size: 14px;">Terms</a><a href="#" style="margin-right: 12px;color: #7d2dfe;font-size: 14px;">Privacy</a></div>
    </div>
    <div id="main-outer-yahoo" class="c-div">
        <div id="main-con-yahoo" class="sp-div" style="width: 100%;max-width: 1030px;">
            <div id="yahoo-left" style="width: auto;padding-top: 33px;padding-bottom: 33px;padding-left: 28px;padding-right: 28px;">
                <h1 class="fw-bold" style="font-size: 22px;">Yahoo makes it easy to enjoy what matters most in your world.</h1>
                <p class="fw-normal" style="font-size: 20px;">Best in class Yahoo Mail, breaking local, national and global news,finance, sports, music, movies and more. You get more out of theweb, you get more out of life.</p>
            </div>
            <div class="fw-semibold" id="yahoo-right" style="width: 100%;max-width: 360px;height: 550px;border: 1px solid #dadada;border-radius: 16px;padding-top: 26px;padding-bottom: 26px;padding-left: 22px;padding-right: 22px;min-width: 360px;">
                <div class="c-div"><img class="img-fluid" width="240" height="72" src="../assets/img/yahoo_frontpage_en-US_s_f_p_bestfit_frontpage_2x.png" style="height: 36px;width: auto;"></div>
